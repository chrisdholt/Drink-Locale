...
setTimeout(function() {
  ...
  //THE LINE BELOW IS JUST HERE FOR TESTING... IT SHOULD NOT BE IN THE PERMANENT CODE!!!!
    triedHistoryArray.push(workingArray[randomBeerIndex]) // THE LINE ABOVE IS JUST FOR TESTING... IT SHOULD NOT BE IN THE PERMANENT CODE
 // puts beer in history of beers that have been suggested or tried
  console.log("first random beer:");
  console.log(workingArray[randomBeerIndex])
...
getRandomBeerByStyle("ipa");
getRandomBeerByStyle('stoutPorter');
getRandomBeerByStyle('scotch');
getRandomBeerByStyle('sour');
// getRandomBeer();  // needs to be linked to an event listener\


// setTimeout(function() { suggestSimilar(ipa); }, 16000);
